...
import com.mycillin.partner.activity.SearchResultActivity;
...
public class SearchResultAdapter extends RecyclerView.Adapter<SearchResultAdapter.MyViewHolder> {
    ...
    private ArrayList<SearchResultItem> arraySearchResultItem;

    public SearchResultAdapter(List<SearchResultItem> searchResultItem, int requestCode, SearchResultActivity searchResultActivity) {
        this.searchResultItem = searchResultItem;
        this.arraySearchResultItem = new ArrayList<>();
        this.arraySearchResultItem.addAll(searchResultItem);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final SearchResultItem resultList = searchResultItem.get(position);
    ...
    public void filter(String query) {
        ...
        for (SearchResultItem l : arraySearchResultItem) {
        ...
        Collections.sort(searchResultItem, new Comparator<SearchResultItem>() {
            @Override
